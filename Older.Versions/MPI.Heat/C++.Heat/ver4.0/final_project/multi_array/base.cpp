...
template <class _T, _size_type _NumDim>
  inline
  _array<_T, _NumDim>::_array(_shape_type _shape)
...
template <typename ... Args>
  inline
  _T& _array<_T, _NumDim>::operator()(Args ... args) {
...
template <class _T, _size_type _NumDim>
  inline 
  _T& _array<_T, _NumDim>::operator[](_size_type index) {
...
template <class _T, _size_type _NumDim>
  inline 
  void _array<_T, _NumDim>::fill(const _T& value) {
std::fill_n(begin(), size(), value);
  }

template <class _T, _size_type _NumDim>
  inline 
  void _array<_T, _NumDim>::assign(const _T& value)
  { fill(value); }


template <class _U, _detail::_types::_size_type _Dims>
std::ostream& operator<<(std::ostream& os, const _array<_U, _Dims>& in) {
