...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \draw[thick, ->] (0,0) -- (12em, 0) node[right] {$x$};
    \draw[thick, ->] (0,0) -- (0, 10em) node[above] {$y$};
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    % Draw a grid with steps of 1 cm
    \def\gridsize{20em};
    \draw[help lines, step=1em] (0,0) grid (\gridsize,\gridsize);
  
    % Draw axes
    \draw[thick,->] (0,0) -- (\gridsize,0) node[right] {$x$};
    \draw[thick,->] (0,0) -- (0,\gridsize) node[above] {$y$};

    \node at (11em,8.5em) {MPI Communication};
    \node at (0em,10.5em) {OpenMP single};
    \node at (0em,1.5em) {OpenMP single};

    \node at (11em,4em) {Update Grid};
    \node at (11em,13em) {Update Grid};
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    % \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.58\textwidth]{figure/FIG_Schematic_Hybrid1.pdf}};
