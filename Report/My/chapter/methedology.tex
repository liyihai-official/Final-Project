...
According to the general setups in section \ref{SEC_General_Form}, and CFL rules
\begin{align}
 & \Delta t \leqslant \frac{\min\{\Delta x, \Delta y\}^2}{2\lambda2^2} \\
 & w_x = \frac{\lambda \Delta t}{\Delta x^2}, w_y = \frac{\lambda \Delta t}{\Delta y^2} \\
 & diag_x = -2 + \frac{\Delta x^2}{2\lambda\Delta t}, diag_y = -2 + \frac{\Delta y^2}{2\lambda\Delta t}
\end{align}
